...
const ready = Boolean(rawServiceAccount && targetUsername && Number.isFinite(grantAmount) && grantAmount > 0 && grantId);
...
async function run() {
  ...
  const firestoreValue = value => ({ integerValue: String(Math.floor(Number(value))) });
